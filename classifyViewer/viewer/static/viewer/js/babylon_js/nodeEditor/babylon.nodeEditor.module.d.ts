 ...
 * @returns
 */
export function GetGeneralProperties(props: IPropertyComponentProps): import("react/jsx-runtime").JSX.Element;
/**
 * NOTE This is intentionally a function to avoid another wrapper JSX element around the lineContainerComponent, and will ensure
 * the lineContainerComponent gets properly rendered as a child of the Accordion
 * @param props
 * @returns
 */
export function GetGenericProperties(props: IPropertyComponentProps): import("react/jsx-runtime").JSX.Element;
...
declare module "babylonjs-node-editor/fluent/primitives/uploadButton" {
...
declare module "babylonjs-node-editor/fluent/primitives/tooltip" {
...
declare module "babylonjs-node-editor/fluent/primitives/toast" {
...
declare module "babylonjs-node-editor/fluent/primitives/textureSelector" {
import { BaseTexture } from "babylonjs/Materials/Textures/baseTexture";
import { Scene } from "babylonjs/scene";
import { Nullable } from "babylonjs/types";
import { FunctionComponent } from "react";
...
export const SpinButton: import("react").ForwardRefExoticComponent<import("babylonjs-node-editor/fluent/primitives/primitive").BasePrimitiveProps & {
    value: number;
    infoLabel?: import("babylonjs-node-editor/fluent/primitives/infoLabel").InfoLabelParentProps;
} & {
    onChange: (value: number) => void;
} & {
    min?: number;
...
declare module "babylonjs-node-editor/fluent/primitives/skeletonSelector" {
import { FunctionComponent } from "react";
import { Scene } from "babylonjs/scene";
import { Nullable } from "babylonjs/types";
...
declare module "babylonjs-node-editor/fluent/primitives/popover" {
...
declare module "babylonjs-node-editor/fluent/primitives/nodeSelector" {
import { FunctionComponent } from "react";
import { Scene } from "babylonjs/scene";
import { Nullable } from "babylonjs/types";
...
declare module "babylonjs-node-editor/fluent/primitives/materialSelector" {
import { FunctionComponent } from "react";
import { Scene } from "babylonjs/scene";
import { Nullable } from "babylonjs/types";
...
export const Link: import("react").ForwardRefExoticComponent<import("babylonjs-node-editor/fluent/primitives/primitive").BasePrimitiveProps & {
    value: string;
    infoLabel?: import("babylonjs-node-editor/fluent/primitives/infoLabel").InfoLabelParentProps;
} & {
    /**
...
declare module "babylonjs-node-editor/fluent/primitives/entitySelector" {
import { Nullable } from "babylonjs/types";
import { ImmutablePrimitiveProps, PrimitiveProps } from "babylonjs-node-editor/fluent/primitives/primitive";
type Entity = {
    uniqueId: number;
};
/**
...
export const ColorPickerPopup: import("react").ForwardRefExoticComponent<{
    isLinearMode?: boolean;
} & import("babylonjs-node-editor/fluent/primitives/primitive").BasePrimitiveProps & {
    value: Color3 | Color4;
    infoLabel?: import("babylonjs-node-editor/fluent/primitives/infoLabel").InfoLabelParentProps;
} & {
...
declare module "babylonjs-node-editor/fluent/hoc/textureUpload" {
import { FunctionComponent } from "react";
import { BaseTexture } from "babylonjs/Materials/Textures/baseTexture";
import { Scene } from "babylonjs/scene";
...
declare module "babylonjs-node-editor/fluent/hoc/childWindow" {
...
declare module "babylonjs-node-editor/fluent/hoc/propertyLines/comboBoxPropertyLine" {
import { FunctionComponent } from "react";
import { PropertyLineProps } from "babylonjs-node-editor/fluent/hoc/propertyLines/propertyLine";
import { ComboBoxProps } from "babylonjs-node-editor/fluent/primitives/comboBox";
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        ...
        activeNode: BABYLON.Nullable<BABYLON.NodeEditor.SharedUIComponents.GraphNode>;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * @param engageActiveRefresh if active refresh should be engaged
     */
    export function ForceRebuild(source: any, stateManager: BABYLON.NodeEditor.SharedUIComponents.StateManager, propertyName: string, notifiers?: BABYLON.IEditablePropertyOption["notifiers"], engageActiveRefresh?: boolean): void;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type UploadButtonProps = Omit<BABYLON.NodeEditor.SharedUIComponents.ButtonProps, "onClick" | "icon"> & {
        /**
         * Callback when files are selected
         */
        onUpload: (files: FileList) => void;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type TextureSelectorProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<BABYLON.Nullable<BABYLON.BaseTexture>> & {
        /**
         * The scene to get textures from
         */
        scene: BABYLON.Scene;
         ...
         */
        cubeOnly?: boolean;
    } & Omit<BABYLON.NodeEditor.SharedUIComponents.EntitySelectorProps<BABYLON.BaseTexture>, "getEntities" | "getName">;
    /**
     * A primitive component with a ComboBox for selecting from existing scene textures
     * and a button for uploading new texture files.
     * @param props TextureSelectorProps
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type SkeletonSelectorProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<BABYLON.Nullable<BABYLON.Skeleton>> & {
        /**
         * The scene to get skeletons from
         */
        scene: BABYLON.Scene;
    ...
    } & Omit<BABYLON.NodeEditor.SharedUIComponents.EntitySelectorProps<BABYLON.Skeleton>, "getEntities" | "getName">;
    /**
     * A primitive component with a ComboBox for selecting from existing scene skeletons.
     * @param props SkeletonSelectorProps
     * @returns SkeletonSelector component
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type NodeSelectorProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<BABYLON.Nullable<BABYLON.Node>> & {
        /**
         * The scene to get nodes from
         */
        scene: BABYLON.Scene;
    ...
    } & Omit<BABYLON.NodeEditor.SharedUIComponents.EntitySelectorProps<BABYLON.Node>, "getEntities" | "getName">;
    /**
     * A primitive component with a ComboBox for selecting from existing scene nodes.
     * @param props NodeSelectorProps
     * @returns NodeSelector component
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type MaterialSelectorProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<BABYLON.Nullable<BABYLON.Material>> & {
        /**
         * The scene to get materials from
         */
        scene: BABYLON.Scene;
    ...
    } & Omit<BABYLON.NodeEditor.SharedUIComponents.EntitySelectorProps<BABYLON.Material>, "getEntities" | "getName">;
    /**
     * A primitive component with a ComboBox for selecting from existing scene materials.
     * @param props MaterialSelectorProps
     * @returns MaterialSelector component
...
declare module BABYLON.NodeEditor.SharedUIComponents {
     ...
     * Props for the EntitySelector component
     */
    export type EntitySelectorProps<T extends Entity> = (PrimitiveProps<BABYLON.Nullable<T>> | BABYLON.NodeEditor.SharedUIComponents.ImmutablePrimitiveProps<BABYLON.Nullable<T>>) & {
        /**
         * Function to get the list of entities to choose from
         */
        getEntities: () => T[];
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    export type ContextMenuProps = BABYLON.NodeEditor.SharedUIComponents.BasePrimitiveProps & (ContextMenuWithIconProps | ContextMenuWithTriggerProps) & {
        /**
         * Array of menu items to display.
         */
        items: ContextMenuItem[];
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    export type ComboBoxProps = BABYLON.NodeEditor.SharedUIComponents.PrimitiveProps<string> & {
        /**
         * Label for the ComboBox
         */
        label: string;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    export var Button: import("react").ForwardRefExoticComponent<BABYLON.NodeEditor.SharedUIComponents.BasePrimitiveProps & {
        onClick?: (e?: React.MouseEvent<HTMLButtonElement>) => unknown | Promise<unknown>;
        icon?: any;
        appearance?: "subtle" | "transparent" | "primary" | "secondary";
        label?: string;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        export type HexPropertyLineProps = BABYLON.NodeEditor.SharedUIComponents.NumberInputPropertyLineProps & {
        numBits?: 32 | 24 | 16 | 8;
    };
    /**
     * Takes a number representing a Hex value and converts it to a hex string then wraps the TextInput in a PropertyLine
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type NodeSelectorPropertyLineProps = BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<BABYLON.Nullable<BABYLON.Node>> & BABYLON.NodeEditor.SharedUIComponents.NodeSelectorProps;
...
declare module BABYLON.NodeEditor.SharedUIComponents {
    ...
    /**
     * Wraps a dropdown in a property line
     * @param props - BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps and BABYLON.NodeEditor.SharedUIComponents.DropdownProps
     * @returns property-line wrapped dropdown
     */
    export var DropdownPropertyLine: import("react").ForwardRefExoticComponent<DropdownPropertyLineProps<BABYLON.NodeEditor.SharedUIComponents.AcceptedDropdownValue> & import("react").RefAttributes<HTMLDivElement>>;
    /**
     * Dropdown component for number values.
     */
...
declare module BABYLON.NodeEditor.SharedUIComponents {
        type ComboBoxPropertyLineProps = BABYLON.NodeEditor.SharedUIComponents.ComboBoxProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps<string>;
    /**
     * A property line with a filterable ComboBox
     * @param props - BABYLON.NodeEditor.SharedUIComponents.ComboBoxProps & BABYLON.NodeEditor.SharedUIComponents.PropertyLineProps
     * @returns property-line wrapped ComboBox component
     */
