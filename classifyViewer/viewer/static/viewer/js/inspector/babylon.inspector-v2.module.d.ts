...
export * from "babylonjs-inspector/services/settingsContext";
...
declare module "babylonjs-inspector/utils/snippetUtils" {
/**
...
export function MakeShellServiceDefinition({ leftPaneDefaultWidth, leftPaneMinWidth, rightPaneDefaultWidth, rightPaneMinWidth, toolbarMode, sidePaneRemapper, }?: ShellServiceOptions): ServiceDefinition<[IShellService, IRootComponentService], []>;
export {};

}
declare module "babylonjs-inspector/services/settingsContext" {
import { IReadonlyObservable } from "babylonjs/Misc/observable";
import { IService } from "babylonjs-inspector/modularity/serviceDefinition";
export const SettingsContextIdentity: unique symbol;
/**
...
import { IService, ServiceDefinition } from "babylonjs-inspector/modularity/serviceDefinition";
import { ISettingsContext } from "babylonjs-inspector/services/settingsContext";
import { IShellService } from "babylonjs-inspector/services/shellService";
...
import { Camera, IDisposable, Light, Scene } from "babylonjs/index";
import { IService, ServiceDefinition } from "babylonjs-inspector/modularity/serviceDefinition";
 ...
 */
export function ApplyChannelsToTextureDataAsync(texture: BaseTexture, width: number, height: number, face: number, channels: TextureChannelsToDisplay, lod?: number): Promise<Uint8Array>;
...
export function useThemeMode(): {
    isDarkMode: boolean;
    themeMode: TernaryDarkMode;
    setThemeMode: import("react").Dispatch<import("react").SetStateAction<TernaryDarkMode>>;
};
/**
 * Sets the theme mode.
 * @param mode The desired theme mode (system/dark/light).
 */
export function SetThemeMode(mode: TernaryDarkMode): void;
...
import { ISettingsContext } from "babylonjs-inspector/services/settingsContext";
import { HorizontalLocation, VerticalLocation } from "babylonjs-inspector/services/shellService";
/**
 ...
 */
export function useCompactMode(): readonly [boolean, import("react").Dispatch<import("react").SetStateAction<boolean>>, () => void];
/**
 ...
 */
export function useDisableCopy(): readonly [boolean, import("react").Dispatch<import("react").SetStateAction<boolean>>, () => void];
/**
 * Gets the side pane dock overrides configuration.
 * @returns A record mapping side pane IDs to their dock locations.
 */
export function useSidePaneDockOverrides(): readonly [Record<string, Readonly<{
    horizontalLocation: HorizontalLocation;
    verticalLocation: VerticalLocation;
 ...
 */
export function useAngleConverters(settings: ISettingsContext): readonly [(angle: number, wrap?: boolean) => number, (angle: number, wrap?: boolean) => number, boolean];
 ...
 * @returns
 */
export const SettingsPopover: FunctionComponent<PropsWithChildren<{}>>;
...
import { FunctionComponent } from "react";
import { GLTFExtensionOptionsType, GLTFLoaderOptionsType } from "babylonjs-inspector/services/panes/tools/import/gltfLoaderOptionsService";
...
declare module INSPECTOR {
    ...
    export var SettingsContextIdentity: unique symbol;
    /**
     * SettingsContext provides a set of settings used across the inspector.
     */
    export interface ISettingsContext extends IService<typeof SettingsContextIdentity> {
         ...
         * Observable that fires whenever a setting changes.
         */
        readonly settingsChangedObservable: BABYLON.IReadonlyObservable<ISettingsContext>;
    }
    ...
    export interface ISelectionService extends IService<typeof SelectionServiceIdentity> {
         ...
         * Gets or sets the currently selected entity.
         */
        selectedEntity: BABYLON.Nullable<unknown>;
        /**
         * An observable that notifies when the selected entity changes.
         */
        readonly onSelectedEntityChanged: BABYLON.IReadonlyObservable<void>;
    }
    export var SelectionServiceDefinition: ServiceDefinition<[ISelectionService], [IShellService, ISettingsContext]>;
    ...
    export var PickingServiceDefinition: ServiceDefinition<[], [ISceneContext, IShellService, ISelectionService, IGizmoService, ISettingsContext]>;


    export var MiniStatsServiceDefinition: ServiceDefinition<[], [ISceneContext, IShellService]>;


    export var GizmoToolbarServiceDefinition: ServiceDefinition<[], [ISceneContext, IShellService, ISelectionService, IGizmoService]>;
    ...
    export var GizmoServiceDefinition: ServiceDefinition<[IGizmoService], []>;
    ...
    export var SettingsServiceDefinition: ServiceDefinition<[ISettingsContext, ISettingsService], [IShellService, ISceneContext]>;
    ...
    export var TextureExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var SpriteManagerExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var SoundExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var SkeletonExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;
    ...
    export interface ISceneExplorerService extends IService<typeof SceneExplorerServiceIdentity> {
         ...
         * @param section A description of the section to add.
         */
        addSection<T>(section: SceneExplorerSection<T>): BABYLON.IDisposable;
        /**
         * Adds a new command (e.g. "Delete", "Rename", etc.) that can be executed on entities in the scene explorer.
         * @param command A description of the command to add.
         */
        addEntityCommand<T>(command: SceneExplorerCommandProvider<T>): BABYLON.IDisposable;
        /**
         * Adds a new command that can be executed on sections in the scene explorer.
         * @param command A description of the command to add.
         */
    ...
    export var PostProcessExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var ParticleSystemExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var NodeExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext, IGizmoService]>;


    export var MaterialExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var GuiExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var FrameGraphExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var EffectLayerExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;
    ...
    export var AtmosphereExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var AnimationGroupExplorerServiceDefinition: ServiceDefinition<[], [ISceneExplorerService, ISceneContext]>;


    export var TransformPropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService, ISettingsContext]>;


    export var TexturePropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService, ISettingsContext, ITextureEditorService]>;


    export var SpritePropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService, ISelectionService, ISettingsContext]>;
    ...
    export var MaterialPropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService, ISelectionService, ISettingsContext]>;


    export var LightPropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService]>;
    ...
    export var CameraPropertiesServiceDefinition: ServiceDefinition<[], [IPropertiesService, ISettingsContext]>;
     ...
     * @returns the 8-bit texture data
     */
    export function ApplyChannelsToTextureDataAsync(texture: BABYLON.BaseTexture, width: number, height: number, face: number, channels: TextureChannelsToDisplay, lod?: number): Promise<Uint8Array>;
     ...
     * @returns The created resource.
     */
    export function useResource<T extends BABYLON.IDisposable>(factory: () => T): T;
    /**
     * Custom hook to manage an asynchronous resource with automatic disposal. The resource is created once initially, and recreated
     * if the factory function changes. Whenever the resource is recreated, the previous instance is disposed. The final
     * instance is disposed when the component using this hook unmounts.
     ...
     * @returns The created resource.
     */
    export function useAsyncResource<T extends BABYLON.IDisposable>(factory: (abortSignal: AbortSignal) => Promise<T>): T | undefined;
     ...
     * @returns
     */
    export var SettingsPopover: React.FunctionComponent<React.PropsWithChildren<{}>>;
    ...
    export var CreateToolsServiceDefinition: ServiceDefinition<[], [IShellService, ISceneContext]>;
    var _default: {
        readonly serviceDefinitions: readonly [ServiceDefinition<[], [IShellService, ISceneContext]>];
    };
