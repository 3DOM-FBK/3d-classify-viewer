"""
Django settings for classifyViewer project.
...
SECRET_KEY = 'django-insecure-gyg1@$3v%2*ryw(za@vhw)0a%4m*=_=bc4jz-q8!)maz(u2-ty'
...
ROOT_URLCONF = 'classifyViewer.urls'
...
WSGI_APPLICATION = 'classifyViewer.wsgi.application'
...
# 🔧 Increase the upload limit (default is 2.5MB)
